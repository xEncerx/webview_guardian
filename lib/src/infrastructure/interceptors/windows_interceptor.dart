...
/// Adapter that implements [TrafficInterceptor] for Windows using InAppWebView's shouldInterceptRequest.
class WindowsInterceptorAdapter implements TrafficInterceptor {
  /// Creates a [WindowsInterceptorAdapter] instance.
  WindowsInterceptorAdapter(FilterRepository filterRepository)
  ...
  Future<void> onEngineUpdated() async {
    // No action needed for Windows when the engine is updated.
  }
